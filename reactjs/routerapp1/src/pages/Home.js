...
const Home=()=>{
  ...
  <center><h3>BankOffers</h3></center>
   ...
   <div className="row">
    <div className="col-md-3">
          <div className="card" style={{ width: "18rem" }}>
            <img src={cd1} className="card-img-top" alt="Card Example" />
            <div className="card-body">
                <h5 className="card-title">Bank-1</h5>
            </div>
          </div>
    </div>
    <div className="col-md-3">
          <div className="card" style={{ width: "18rem" }}>
            <img src={cd1} className="card-img-top" alt="Card Example" />
            <div className="card-body">
                <h5 className="card-title">Bank-2</h5>
            </div>
          </div>
    </div>
    <div className="col-md-3">
          <div className="card" style={{ width: "18rem" }}>
            <img src={cd1} className="card-img-top" alt="Card Example" />
            <div className="card-body">
                <h5 className="card-title">Bank-3</h5>
            </div>
          </div>
    </div>
    <div className="col-md-3">
          <div className="card" style={{ width: "18rem" }}>
            <img src={cd1} className="card-img-top" alt="Card Example" />
            <div className="card-body">
                <h5 className="card-title">Bank-4</h5>
            </div>
          </div>
    </div>
   </div>
